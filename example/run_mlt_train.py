...
def get_ali_ccp_data_dict(model_name, data_path='./data/ali_ccp'):
    ...
    data["ctcvr_label"] = data['cvr_label'] * data['ctr_label'] # 新增1列
...
"""
python mlt_trainer.py --model_name SharedBottom
python mlt_trainer.py --model_name ESMM
python mlt_trainer.py --model_name MMOE
python mlt_trainer.py --model_name PLE
python mlt_trainer.py --model_name AITM
"""